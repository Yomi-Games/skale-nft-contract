...
// For local deployment of contract
// npx hardhat node
// npx hardhat run --network localhost scripts/deploy_yomigardens.ts
...
async function main() {
  ...
  // Helpful to seed some external wallet with some eth if you're testing
  // const recipient = "0x15c4a71cc619d8899acaa45785fb3bdc6b4a9de1";
  ...
  const contract = await upgrades.deployProxy(
    ...
    [
      "YomiGardens",
      "YGAR",
      "https://api.yomigardens.com/api/tokens/",
      "0x1219F779510EFbD6f6Ec7C9ceAc9970Fe2613444",
      5,
      "0xA59137FD7C9cF5de04E9cF4770A2af5d2BD2cB89",
    ],
    {
